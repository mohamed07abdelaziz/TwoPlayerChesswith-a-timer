...
#ifndef LV_ATTRIBUTE_IMG_BLUEROOK
#define LV_ATTRIBUTE_IMG_BLUEROOK
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_BLUEROOK uint8_t bluerook_map[] = {
